...
<!-- Our Custom CSS -->
<link href="{{asset('assets/css/ourstyle.css')}}" rel='stylesheet' type='text/css' />
...
<body class="cbp-spmenu-push">
    ...
    <div class="main-content">
        @include('layout.general_sidebar')
        @include('layout.general_topbar')

        <div id="page-wrapper">
            <h2 style="font-weight: bold">@yield('title')</h2> <br>
            <div class="main-page @yield('main-class')">
                @yield('content')
            </div>
        </div>

        @include('layout.general_footer')
    </div>
	...
	<script src="{{asset('assets/js/SimpleChart.js')}}"></script>
    <script>
        var graphdata1 = {
            linecolor: "#CCA300",
            title: "Monday",
	...
	<!-- //Bootstrap Core JavaScript -->
    <script type="text/javascript" src="{{asset('assets/js/jquery.jqcandlestick.min.js')}}"></script>
